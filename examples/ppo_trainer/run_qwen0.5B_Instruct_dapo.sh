...
math_test_path=/workspace/verl/data/offline_eval/math__math_500.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/data1/wty/standard_models/Qwen2.5-0.5B-Instruct \
    ...
    critic.model.path=/data1/wty/standard_models/Qwen2.5-0.5B-Instruct \
